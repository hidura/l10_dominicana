...
odoo.define('l10n_do_pos.models', function (require) {
    ...
    models.load_fields('account.journal', [
        ...
        'l10n_do_document_type_ids',
        'l10n_do_payment_form',
    ]);

    models.load_models({
        model: 'account.journal',
        fields: ['name', 'l10n_latam_use_documents', 'l10n_do_document_type_ids'],
    ...
    models.Order = models.Order.extend({
        ...
        latam_document_type_changed: function () {
            ...
            if (current_order){
                ...
                //console.log(this);
                // this.gui.screen_instances.payment
        ...
        set_client: function(client) {
            ...
            if (client && client != undefined){
                if (self.pos.ncf_types_data.issued[client.l10n_do_dgii_tax_payer_type]!=undefined){
        ...
        get_next_sequence: function (client) {
            var self = this;

            var latam_document_type=self.get_latam_document_type(
                self.pos.get_latam_document_type_by_l10n_do_ncf_type(
                    self.pos.ncf_types_data.issued[client.l10n_do_dgii_tax_payer_type][0])
            );
            rpc.query({
